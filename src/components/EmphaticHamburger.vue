...
<template>
  <plain-hamburger v-if="reversed" class="hamburger--emphatic-r" v-on="$listeners"/>
  <plain-hamburger v-else class="hamburger--emphatic" v-on="$listeners"/>
</template>
