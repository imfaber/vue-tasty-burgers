...
<template>
  <plain-hamburger v-if="reversed" class="hamburger--elastic-r" v-on="$listeners"/>
  <plain-hamburger v-else class="hamburger--elastic" v-on="$listeners"/>
</template>
