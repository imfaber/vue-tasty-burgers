...
<template>
  <plain-hamburger v-if="reversed" class="hamburger--collapse-r" v-on="$listeners"/>
  <plain-hamburger v-else class="hamburger--collapse" v-on="$listeners"/>
</template>
